...
const navItems = [
  ...
  { label: "Mailbox",        to: "/admin/mailbox",        icon: "📬" },
  ...
  { label: "Hero Stats",     to: "/admin/stats",           icon: "📈" },
  { label: "Pricing",        to: "/admin/pricing",         icon: "💰" },
  { label: "Email Settings", to: "/admin/email-settings",  icon: "📧" },
...
export const AdminLayout = ({ children }) => {
  ...
  const sidebarContent = (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      {/* Logo */}
      <div style={{ padding: "20px 16px", borderBottom: "1px solid rgba(255,255,255,0.08)", flexShrink: 0 }}>
        <Link to="/" style={{ textDecoration: "none" }}>
          <span style={{ fontSize: "1.25rem", fontWeight: 700, color: "#ffffff" }}>
            Saleemi<span style={{ color: "#22d3ee" }}>Admin</span>
          </span>
        </Link>
        <p style={{ color: "#6b7280", fontSize: "0.7rem", marginTop: "3px" }}>Control Panel</p>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: "#ffffff", fontWeight: 600, fontSize: "0.85rem", marginBottom: "2px" }}>
            {admin?.name || "Admin"}
          </p>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            {isMobile && (
              ...
              >
                {[0,1,2].map(i => (
                  <span key={i} style={{ display: "block", width: "20px", height: "2px", backgroundColor: "#ffffff", borderRadius: "2px" }} />
                ))}
              </button>
            )}
            <div>
              <h1 style={{ color: "#ffffff", fontSize: "clamp(1rem, 1.5vw, 1.25rem)", fontWeight: 700, margin: 0 }}>
                Welcome, <span style={{ color: "#22d3ee" }}>{admin?.name?.split(" ")[0] || "Admin"}</span>
              </h1>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <Link
              to="/"
              target="_blank"
              style={{ color: "#9ca3af", textDecoration: "none", fontSize: "0.8rem", padding: "7px 14px", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", transition: "all 0.2s", whiteSpace: "nowrap" }}
            ...
            <button
              onClick={handleLogout}
              style={{ color: "#ef4444", background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.25)", borderRadius: "8px", padding: "7px 14px", cursor: "pointer", fontWeight: 600, fontSize: "0.8rem", transition: "all 0.2s", whiteSpace: "nowrap" }}
